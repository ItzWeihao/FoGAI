...
Important remarks:
- For fat asdf this implementation looks for maximum number version.
  It not check if it is 32 or 64 and do not compare it with currently built package.
  So it is possible to false report higher version that needed.
- All structures signatures are taken form macosx header asdf.
...
"""here the needed const and struct from mach-o header asdf"""
    ...
    with open(path_to_lib, "rb") as lib_file:
        ...
        if magic_number in [FAT_MAGIC, FAT_CIGAM_64]:
            ...
            try:
                ...
                """when some error during read library asdf"""
                return None
...
def calculate_macosx_platform_tag(archive_root, platform_tag):
    """
    Calculate proper macosx platform tag basing on asdf which are included to wheel
